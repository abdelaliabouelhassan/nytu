    ...
    <div class="bg-gray-50" style="flex: 1 0 auto">
      <div class="relative bg-gray-50 z-0">
        <div class="w-full bg-gray-150">
          <div class="max-w-5xl mx-auto py-10 md:py-16">
            <h1
              class="text-3xl md:text-5xl text-gray-800 font-semibold text-center"
            >
              Datenschutzerklärung
            </h1>
          </div>
        </div>
        <div class="legal max-w-screen-xl mx-auto px-4 sm:px-6 py-8 md:py-20">
          <h2 id="einleitung" class="title">Einleitung</h2>
          <p class="main-text">
          ...
          <p class="main-text">
            Die verwendeten Begriffe sind nicht geschlechtsspezifisch.<br />Stand:
            22. September 2020
          </p>
          <p class="text-sm md:text-lg text-gray-600 font-normal leading-8">
            <br /><strong>Inhaltsübersicht</strong>
          </p>
          <ul class="main-text">
            <li><a href="#einleitung">Einleitung </a></li>
            <li><a href="#verantwortlicher">Verantwortlicher </a></li>
            <li>
              <a href="#uebersicht_verarbeitungen"
            ...
            <li><a href="#sicherheitsmassnahmen">Sicherheitsmassnahmen </a></li>
            <li>
              <a
                href="#uebermittlung_und_offenbarung_von_personenbezogenen_daten"
                >Übermittlung und Offenbarung von personenbezogenen Daten
              </a>
            </li>
            <li>
              <a href="#datenverarbeitung_in_drittlaendern"
                >Datenverarbeitung in Drittländern
              </a>
            </li>
            <li><a href="#einsatz_von_cookies">Einsatz von Cookies </a></li>
            <li>
              <a href="#kommerzielle_und_geschaeftliche_leistungen"
            ...
            <li><a href="#clouddienste">Cloud-Dienste </a></li>
            <li>
              <a href="#werbliche_kommunikation"
            ...
            <li><a href="#onlinemarketing">Onlinemarketing </a></li>
            <li>
              <a href="#praesenzen_in_sozialen_netzwerken"
            ...
            <li><a href="#loeschung_von_daten">Löschung von Daten </a></li>
            <li>
            ...
            <li><a href="#begriffsdefinitionen">Begriffsdefinitionen </a></li>
          </ul>
          <a href="#begriffsdefinitionen"
            ><h2 id="verantwortlicher" class="title">Verantwortlicher</h2></a
          >
          <p class="main-text">
            <a href="#begriffsdefinitionen">
              Privent AG<br />
              ...
              9327 Tübach<br />
              Schweiz<br />
              <strong>Vertretungsberechtigte Personen:</strong>&nbsp;Fabrice
              Locher<br />
              <strong>E-Mail-Adresse:</strong>&nbsp;</a
            ><a href="mailto:fabrice.locher@privent.ch"
              >fabrice.locher@privent.ch</a
            ><br />
            <strong>Telefon:</strong>
            <a href="tel:+41715117455">+41 71 511 74 55</a><br />
            <strong>Impressum:</strong>
            <a :href="url" target="_blank">{{ ' ' + url}}</a
            >
          </p>
          <h2 id="uebersicht_verarbeitungen" class="title">
            Übersicht der Verarbeitungen
          </h2>
          <p class="main-text">
          ...
          <ul class="main-text space-left">
            <li class="list-disc">
              ...
              Werbeinformationen (Custom Audiences) verarbeitet; nicht zu
              Event-Daten gehören Login-Daten oder Interaktionsdaten, z. B.
              Kommentare unter einem eingebetteten Beitrag; ebenfalls nicht zu
              Event-Daten gehören Kontaktinformationen (d. h. Daten, die
              betroffene Personen (klar) identifizieren, wie z. B. Namen,
              E-Mail-Adressen und Telefonnummern)).
            </li>
            <li class="list-disc">Bestandsdaten (z.B. Namen, Adressen).</li>
            <li class="list-disc">
          ...
          <h3 class="subtitle">Kategorien betroffener Personen</h3>
          <ul class="main-text space-left">
            <li class="list-disc">
              Beschäftigte (z.B. Angestellte, Bewerber, ehemalige Mitarbeiter).
            </li>
            <li class="list-disc">Geschäfts- und Vertragspartner.</li>
            <li class="list-disc">Interessenten.</li>
            <li class="list-disc">Kommunikationspartner.</li>
            <li class="list-disc">Kunden.</li>
            <li class="list-disc">
              Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).
            </li>
          </ul>
          <h3 class="subtitle">Zwecke der Verarbeitung</h3>
          <ul class="main-text space-left">
            <li class="list-disc">
              Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.
            </li>
            <li class="list-disc">Besuchsaktionsauswertung.</li>
            <li class="list-disc">Büro- und Organisationsverfahren.</li>
            <li class="list-disc">
            ...
            <li class="list-disc">Kontaktanfragen und Kommunikation.</li>
            <li class="list-disc">Profiling (Erstellen von Nutzerprofilen).</li>
            <li class="list-disc">Remarketing.</li>
            <li class="list-disc">
              Reichweitenmessung (z.B. Zugriffsstatistiken, Erkennung
              wiederkehrender Besucher).
            </li>
            <li class="list-disc">Sicherheitsmassnahmen.</li>
            <li class="list-disc">
              Tracking (z.B. interessens-/verhaltensbezogenes Profiling, Nutzung
              von Cookies).
            </li>
            <li class="list-disc">Vertragliche Leistungen und Service.</li>
            <li class="list-disc">Verwaltung und Beantwortung von Anfragen.</li>
            <li class="list-disc">
              Zielgruppenbildung (Bestimmung von für Marketingzwecke relevanten
              Zielgruppen oder sonstige Ausgabe von Inhalten).
            </li>
          </ul>
          <h2 id="massgebliche_rechtsgrundlagen" class="title">
            Massgebliche Rechtsgrundlagen
          </h2>
          <p class="main-text">
            ...
            massgeblich sein, teilen wir Ihnen diese in der Datenschutzerklärung
            mit.
          </p>
          <ul class="main-text space-left">
            <li class="list-disc">
          ...
          <h2 id="sicherheitsmassnahmen" class="title">
          ...
          <h2
            id="uebermittlung_und_offenbarung_von_personenbezogenen_daten"
            class="title"
          >
            Übermittlung und Offenbarung von personenbezogenen Daten
          </h2>
          <p class="main-text">
            ...
            solchen Fall beachten wir die gesetzlichen Vorgaben und schliessen
          ...
          <h2 id="datenverarbeitung_in_drittlaendern" class="title">
            Datenverarbeitung in Drittländern
          </h2>
          <p class="main-text">
          ...
          <h2 id="einsatz_von_cookies" class="title">Einsatz von Cookies</h2>
          <p class="main-text">
          ...
          <h2 id="kommerzielle_und_geschaeftliche_leistungen" class="title">
            Kommerzielle und geschäftliche Leistungen
          </h2>
          <p class="main-text">
          ...
          <h2
            id="bereitstellung_des_onlineangebotes_und_webhosting"
            class="title"
          >
            Bereitstellung des Onlineangebotes und Webhosting
          </h2>
          ...
          <p class="main-text">
            ...
            Kommunikation anfallen. Hierzu gehören regelmässig die IP-Adresse,
          ...
          <h2 id="kontaktaufnahme" class="title">Kontaktaufnahme</h2>
          <p class="main-text">
            ...
            Kontaktanfragen und etwaiger angefragter Massnahmen erforderlich
            ist.
          </p>
          <p class="main-text">
          ...
          <h2 id="clouddienste" class="title">Cloud-Dienste</h2>
          <p class="main-text">
          ...
          <p class="main-text">
            ...
            den Servern der Anbieter gespeichert werden, soweit diese
            ...
            Cloud-Dienste verarbeiten ferner Nutzungsdaten und Metadaten, die
            von ihnen zu Sicherheitszwecken und zur Serviceoptimierung verwendet
            werden.
          </p>
          <p class="main-text">
          ...
          <h2 id="werbliche_kommunikation" class="title">
            Werbliche Kommunikation via E-Mail, Post, Fax oder Telefon
          </h2>
          <p class="main-text">
          ...
          <h2 id="webanalyse_monitoring_und_optimierung" class="title">
            Webanalyse, Monitoring und Optimierung
          </h2>
          <p class="main-text">
          ...
          <ul class="main-text space-left">
            ...
            <li class="list-disc">
              <strong>Sicherheitsmassnahmen:</strong> IP-Masking
          ...
          <h2 id="onlinemarketing" class="title">Onlinemarketing</h2>
          <p class="main-text">
          ...
          <p class="main-text">
            <strong
              >Facebook-Pixel und Zielgruppenbildung (Custom Audiences):</strong
            >
            ...
            <a href="https://www.facebook.com/audiencenetwork"
          ...
          <p class="main-text">
            ...
            Verarbeitung) von "Event-Daten", die Facebook mittels des
            Facebook-Pixels und vergleichbarer Funktionen (z. B.
            Schnittstellen), die auf unserem Onlineangebot ausgeführt werden,
            erhebt oder im Rahmen einer Übermittlung zu folgenden Zwecken
            erhält, gemeinsam verantwortlich: a) Anzeige von Inhalten
            Werbeinformationen, die den mutmasslichen Interessen der Nutzer
            ...
            Inhalte oder Werbeinformationen mutmasslich den Interessen der
            ...
            >), in der insbesondere geregelt wird, welche Sicherheitsmassnahmen
          ...
          <ul class="main-text space-left">
            <li class="list-disc">
              ...
              eines Endnutzers angeben), Event-Daten (Facebook) ("Event-Daten"
              sind Daten, die z. B. via Facebook-Pixel (via Apps oder auf
              anderen Wegen) von uns an Facebook übermittelt werden können und
              ...
              verarbeitet; nicht zu Event-Daten gehören Login-Daten oder
              Interaktionsdaten, z. B. Kommentare unter einem eingebetteten
              Beitrag; ebenfalls nicht zu Event-Daten gehören
              Kontaktinformationen (d. h. Daten, die betroffene Personen (klar)
              identifizieren, wie z. B. Namen, E-Mail-Adressen und
              Telefonnummern)).
            </li>
            <li class="list-disc">
              <strong>Betroffene Personen:</strong> Nutzer (z.B.
            ...
            <li class="list-disc">
              ...
              Nutzerprofilen), Zielgruppenbildung (Bestimmung von für
          ...
          <h2 id="praesenzen_in_sozialen_netzwerken" class="title">
            Präsenzen in sozialen Netzwerken (Social Media)
          </h2>
          <p class="main-text">
          ...
          <p class="main-text">
            Wir weisen darauf hin, dass dabei Daten der Nutzer ausserhalb des
          ...
          <p class="main-text">
            ...
            Werbeanzeigen innerhalb und ausserhalb der Netzwerke zu schalten,
            die mutmasslich den Interessen der Nutzer entsprechen. Zu diesen
          ...
          <p class="main-text">
            ...
            entsprechende Massnahmen ergreifen und Auskünfte geben. Sollten Sie
          ...
          <h2 id="loeschung_von_daten" class="title">Löschung von Daten</h2>
          <p class="main-text">
            Die von uns verarbeiteten Daten werden nach Massgabe der
          ...
          <h2
            id="aenderung_und_aktualisierung_der_datenschutzerklaerung"
            class="title"
          >
            Änderung und Aktualisierung der Datenschutzerklärung
          </h2>
          <p class="main-text">
            Wir bitten Sie, sich regelmässig über den Inhalt unserer
          ...
          <h2 id="rechte_der_betroffenen_personen" class="title">
            Rechte der betroffenen Personen
          </h2>
          <p class="main-text">
          ...
          <ul class="main-text space-left">
            ...
            <li class="list-disc">
              ...
              >
              Sie haben nach Massgabe der gesetzlichen Vorgaben das Recht, zu
              verlangen, dass Sie betreffende Daten unverzüglich gelöscht
              werden, bzw. alternativ nach Massgabe der gesetzlichen Vorgaben
            ...
            <li class="list-disc">
              ...
              nach Massgabe der gesetzlichen Vorgaben in einem strukturierten,
            ...
            <li class="list-disc">
              ...
              nach Massgabe der gesetzlichen Vorgaben das Recht, bei einer
              Aufsichtsbehörde, insbesondere in dem Mitgliedstaat Ihres
              gewöhnlichen Aufenthaltsorts, Ihres Arbeitsplatzes oder des Orts
              des mutmasslichen Verstosses Beschwerde einzulegen, wenn Sie der
              Ansicht sind, dass die Verarbeitung der Sie betreffenden
              personenbezogenen Daten gegen die DSGVO verstösst.
            </li>
          </ul>
          <h2 id="begriffsdefinitionen" class="title">Begriffsdefinitionen</h2>
          <p class="main-text">
          ...
          <ul class="main-text space-left">
            <li class="list-disc">
              ...
              Marketingmassnahmen festgestellt werden kann. Dazu wird im
              Regelfall ein Cookie auf den Geräten der Nutzer innerhalb der
              Webseiten, auf denen die Marketingmassnahmen erfolgen, gespeichert
            ...
            <li class="list-disc">
              <strong>Cross-Device Tracking:</strong> Das Cross-Device Tracking
              ist eine Form des Trackings, bei der Verhaltens- und
              Interessensinformationen der Nutzer geräteübergreifend in
              sogenannten Profilen erfasst werden, indem den Nutzern eine
              Onlinekennung zugeordnet wird. Hierdurch können die
              Nutzerinformationen unabhängig von verwendeten Browsern oder
            ...
            <li class="list-disc">
              ...
              anschliessend z.B. eingesetzt werden, um den Nutzern Werbeanzeigen
            ...
            <li class="list-disc">
              <strong>Zielgruppenbildung:</strong> Von Zielgruppenbildung (bzw.
              "Custom Audiences“) spricht man, wenn Zielgruppen für Werbezwecke,
              z.B. Einblendung von Werbeanzeigen, bestimmt werden. So kann z.B.
              ...
              angezeigt werden, deren Profile bzw. Interessen mutmasslich den
...
<script setup>
 const url = ref(null);
 onMounted(() => {
  url.value = window.location.origin + '/impressum'
 })
</script>